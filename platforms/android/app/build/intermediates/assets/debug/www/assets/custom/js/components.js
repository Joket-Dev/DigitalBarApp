...
myApp.onPageInit('hamburgers', function(page) {
	$$('.page[data-page=hamburgers] .hamburgers a').on('click', function() {;
...
myApp.onPageInit('progress-bars', function(page) {
	...
	$$('.page[data-page=progress-bars] #progress-bar-determinate-inline .button').on('click', function() {
	...
	$$('.page[data-page=progress-bars] #progress-bar-determinate-inline-load-hide .button').on('click', function() {
